...
public class Program {
    static int Main(string[] args) {
        ...
        var ueVersion = new Option<UE4Version>
            (name: "--ue-version",
             description: "Unreal Engine version",
             getDefaultValue: () => UE4Version.VER_UE4_27);
        ...
        genHierarchy.SetHandler(GenHierarchy, ueVersion, assetInputDirectory, hierarchyOutput);
...
Leading underscores can be used to work around special function names being illegal in the editor.");
    ...
    static void GenCfg(UE4Version ueVersion, string assetPath, string outputDir) {
    ...
    static void GenCfgTree(UE4Version ueVersion, string input, string output) {
    ...
    static void GenJsonTree(UE4Version ueVersion, string assetInputDir, string jsonOutputDir) {
    ...
    static void GenHierarchy(UE4Version ueVersion, string assetInputDir, string hierarchyOutput) {
    ...
    static void CopyImports(UE4Version ueVersion, string assetSource, string assetDestination, IList<int> imports) {
    ...
    static void MergeFunctions(UE4Version ueVersion, string assetSource, string assetDestination) {
    ...
    static void GenBlueprint(UE4Version ueVersion, string contextPath, string assetSource, string assetDestination) {
    ...
    static void FindSchematics(UE4Version ueVersion, string assetInputDir) {
        foreach (var assetPath in GetAssets(assetInputDir)) {
    ...
    static void MakeModRemoveWeaponBobbing(UE4Version ueVersion, string assetInputDirectory, string assetOutputDirectory) {
    ...
    static void MakeModRemoveAllParticles(UE4Version ueVersion) {
