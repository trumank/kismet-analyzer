...
public class Program {
    static int Main(string[] args) {
        ...
        genCfgTree.SetHandler(GenCfgTree, ueVersion, assetInputDirectory, cfgOutputDiretory, projectName);
...
Leading underscores can be used to work around special function names being illegal in the editor.");
    ...
    static void GenCfgTree(EngineVersion ueVersion, string assetInputDir, string output, string projectName) {
        ...
        var hierarchy = new StreamWriter(Path.Join(output, "hierarchy.dot"));
